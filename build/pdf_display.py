    ...
    def __init__(self, parent, filename=None):
        ...
        if filename == None:
            ...
            dlg = wx.FileDialog(None, message = "Choose a file to display",
                                wildcard = wild, defaultDir=os.getenv("HOME"), style=wx.FD_OPEN|wx.FD_CHANGE_DIR)
            ...
            if filename != None:
                # create the dialog
                dlg = PDFdisplay(parent, filename)
            ...
            # forward button
            self.ButtonNext = wx.Button(self, wx.ID_ANY, u"Next",
                            defPos, defSiz, wx.BU_AUTODRAW)
            # backward button
            self.ButtonPrevious = wx.Button(self, wx.ID_ANY, u"Prev",
                            defPos, defSiz, wx.BU_AUTODRAW)
            #======================================================================
